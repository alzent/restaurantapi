...
public class ImageRepository {
	...
	public ImageRepository(Environment env) {
		...
		String connectionString = Objects.requireNonNull(env.getProperty("azure.storage.connectionString"));
		String containerName = Objects.requireNonNull(env.getProperty("azure.storage.photosContainer"));
	...
	public URI Upload(String imageName, ImageBase64 imageBase64) {
		try {
			String blobName = String.format("%s.%s", imageName, imageBase64.getFileExtension());
