...
public class ReviewDto {
	...
	@JsonCreator
	public ReviewDto(@JsonProperty("name") String name, @JsonProperty("email") String email,
			@JsonProperty("comment") String comment, @JsonProperty("imageBase64") String imageBase64Str) {
		this.name = name;
		this.email = email;
